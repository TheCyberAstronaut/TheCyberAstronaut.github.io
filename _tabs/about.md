...
My name is Matthew Hancock or also known as TheCyberAstronaut, I am a graduate from the University of Tulsa with a Bachelor's of Science in Cyber Security.

## Work Experience
***

### SOC Analyst @ [University of Tulsa](https://utulsa.edu/)
...
- Performed web penetration testing and code review on the Paycom application.
- Contributed to multiple projects gaining real world exposure on secure development practices and SaaS business operations.

### Cyber Security Intern @ [ONEOK](https://www.oneok.com/)
**_May 2024 - August 2024_**

- Assisted in automation of configuration and analysis for ONEOK's IdP.
- Learned and developed PowerShell scripts and modules to automate recurring tasks.

## Activities
***

### Infrastructure Lead @ [Root66Tulsa Cyber Clubs](https://root66tulsa.club)
...
### NCAE-C ([National Centers of Academic Excellence in Cybersecurity](https://www.ncaecybergames.org/))
...
- 1st Place in Southwest Regionals